...
interface DevicesState {
  ...
  lastSyncData: Record<string, DeviceSyncData> // deviceId -> data
  ...
  persist(
    (set, get) => ({
      ...
      addDevice: (deviceData) => {
        ...
        // Gamification: XP for connecting a wearable
      ...
      syncDevice: async (deviceId) => {
        ...
        try {
          // Simulate sync delay (in real app, this would call device APIs like HealthKit, Google Fit, etc.)
          await new Promise((resolve) => setTimeout(resolve, 2000))

          // Generate mock sync data (in real app, this would come from device APIs)
          // Apple Watch / HealthKit would provide real data here
          ...
          // Note: Sport program now tracks full sessions, not NEAT minutes
          // Active calories from wearables can be used for general activity tracking
          ...
          // Gamification: XP for syncing wearable
          const gamification = useGamificationStore.getState()
